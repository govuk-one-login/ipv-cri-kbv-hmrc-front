Feature: Happy path
  ...
  Scenario: Happy Path for taxCredits-journey
    ...
    When they not enter account number and continue from the enter-4-digits-bank-account-tax-credits question page
    Then they should see enter account number error message
    When they enter invalid account number and continue from the enter-4-digits-bank-account-tax-credits question page
